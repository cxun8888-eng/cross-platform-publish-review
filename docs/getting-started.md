...
5. 将`多平台发布与作品复盘助手`固定到浏览器工具栏。

扩展卡片应显示“多平台发布与作品复盘助手”。如果仍显示“文数智旅”或“旅策”，请移除旧扩展并确认重新加载的是本仓库的 `browser-extension/` 根目录。
...
3. 当前标签会进入对应官方页面；
4. 如果平台要求登录，先完成官方登录；
5. 按页面右侧“多平台发布与作品复盘助手”的提示手动选择图片；
...
- [ ] 扩展管理页没有红色错误；
- [ ] 扩展弹窗能保存应用地址和回调路径；
- [ ] 从 Demo 点击平台后，官方页面出现多平台发布与作品复盘助手；
- [ ] 未点击最终确认时不会提交作品；
